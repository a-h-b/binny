...
rule binny:
    ...
    params:
        ...
        include_depth_main=config["binning"]["clustering"]["include_depth_main"],
        hdbscan_min_samples=config["binning"]["clustering"]["hdbscan_min_samples"],
        hdbscan_epsilon=config["binning"]["clustering"]["hdbscan_epsilon"],
