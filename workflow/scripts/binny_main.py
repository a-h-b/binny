...
tigrfam2pfam_file = snakemake.input['t2p']
taxon_marker_set_file = snakemake.input['marker_sets']
...
all_good_bins, contig_data_df_org = iterative_embedding(x, x_contigs, depth_dict, all_good_bins,
                                                        starting_completeness, min_purity, min_completeness)
...
write_bins(all_good_bins, assembly, min_comp=int(min_completeness), min_pur=int(min_purity),
           bin_dir='bins_dynamic_marker_sets_v06')
