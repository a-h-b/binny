...
min_completeness = int(snakemake.params['min_completeness'])
starting_completeness = int(snakemake.params['start_completeness'])
...
min_contig_length_marker = min(max(int(nx / 2), min_contig_length_marker), max_contig_length_marker)
