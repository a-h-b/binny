...
final_clust_dict = divide_clusters_by_depth(first_clust_dict, threads, int(min_purity), cluster_mode='OPTICS')
...
conditions = [(final_clust_contig_df['purity'] >= 0.9) & (final_clust_contig_df['completeness'] >= 0.25),
              (final_clust_contig_df['purity'] < 0.9) | (final_clust_contig_df['completeness'] < 0.25)]
